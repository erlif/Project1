...
$val .= $scope->locally()->XML_val('LinkPageAdd', ['', 'ParentID=%s'], true);
$val .= '">';
...
$val .= \SilverStripe\View\SSViewer::execute_template([["type" => "Includes", 'SilverStripe\\CMS\\Controllers\\CMSMain_ViewControls'], 'SilverStripe\\CMS\\Controllers\\CMSMain_ViewControls'], $scope->getItem(), ['PJAXTarget' => 'Content-PageList'], $scope, true);
