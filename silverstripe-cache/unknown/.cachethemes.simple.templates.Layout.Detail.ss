...
$scope->locally()->obj('Coba', null, true); $scope->pushScope();
$val .= '
...
$val .= '" style="text-decoration:none;">Home</a></li>
              <li class="breadcrumb-item"><a href="';

$val .= $scope->locally()->XML_val('BaseHref', null, true);
$val .= '/shop-page" style="text-decoration:none;">Shop</a></li>
...
$val .= $scope->locally()->obj('ImageThumbnail', null, true)->XML_val('URL', null, true);
$val .= '" alt="" class="img-fluid " id="image">
                <div class="owl-carousel owl-theme mt-2">
                  ';

$scope->locally()->obj('Image', null, true); $scope->pushScope(); while (($key = $scope->next()) !== false) {
$val .= '
                    <div class="item">
                      <h4><img src="';
...
$val .= '</h3>
            ...
            <div class="d-flex gap-2">
              ...
              <h5 class="fw-bold text-muted" id="stok">';

$val .= $scope->locally()->XML_val('Stok', null, true);
$val .= '</h5>
            </div>
...
$scope->locally()->obj('Image', null, true); $scope->pushScope(); while (($key = $scope->next()) !== false) {
$val .= '
                <button type="button" class="btn btn-outline-secondary shadow-none" id="button';
...
$val .= $scope->locally()->XML_val('URL', null, true);
$val .= '" id="gambar" alt="" width="24" height="24">
                  <span class="kecil" id="title';
...
$val .= $scope->locally()->XML_val('Spesifikasi', null, true);
$val .= '</div>
              <div class="tab-pane fade mb-2" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab ">
                ';

$val .= $scope->locally()->XML_val('Infopenting', null, true);
$val .= '</div>
            </div>
        ...
        <script>
          document.addEventListener(\'DOMContentLoaded\', function () {
            ...
            document.getElementById(\'image1\').addEventListener(\'click\', function () {
              ...
              updateProductDetails(imgSrc, "';

$val .= $scope->locally()->XML_val('Title2', null, true);
$val .= '", "';

$val .= $scope->locally()->XML_val('SubHarga', null, true);
$val .= '", "';

$val .= $scope->locally()->XML_val('SubStok', null, true);
$val .= '");
            });
...
$val .= $scope->locally()->XML_val('Title3', null, true);
$val .= '", "';

$val .= $scope->locally()->XML_val('SubHarga2', null, true);
$val .= '", "';

$val .= $scope->locally()->XML_val('SubStok2', null, true);
$val .= '");
            });
