...
$val .= \SilverStripe\View\SSViewer::execute_template([["type" => "Includes", 'SilverStripe\\CMS\\Controllers\\CMSMain_Filter'], 'SilverStripe\\CMS\\Controllers\\CMSMain_Filter'], $scope->getItem(), [], $scope, true);
