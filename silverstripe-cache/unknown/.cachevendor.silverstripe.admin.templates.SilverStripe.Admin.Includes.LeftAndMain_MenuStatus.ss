...
$val .= $scope->locally()->XML_val('AdminURL', ['myprofile'], true);
$val .= '" class="cms-login-status__profile-link" title="';

$val .= _t('SilverStripe\Admin\LeftAndMain.PROFILE','{name} profile',['name'=>$scope->locally()->XML_val('Name', null, true)]);
$val .= '">
