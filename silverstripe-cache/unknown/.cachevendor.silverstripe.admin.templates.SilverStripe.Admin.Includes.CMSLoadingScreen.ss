...
$val .= \SilverStripe\View\SSViewer::execute_template([["type" => "Includes", 'SilverStripe/Admin/Includes/CMSLoadingSpinner'], 'SilverStripe/Admin/Includes/CMSLoadingSpinner'], $scope->getItem(), [], $scope, true);
...
$val .= '
    ...
    <noscript><p class="nojs-warning alert alert-warning">';

$val .= _t('SilverStripe\\Admin\\LeftAndMain.REQUIREJS','The CMS requires that you have JavaScript enabled.');
$val .= '</p></noscript>
</div>
';
