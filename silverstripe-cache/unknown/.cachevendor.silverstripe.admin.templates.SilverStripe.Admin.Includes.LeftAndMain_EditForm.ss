...
$val .= \SilverStripe\View\SSViewer::execute_template([["type" => "Includes", 'SilverStripe\\Admin\\BackLink_Button'], 'SilverStripe\\Admin\\BackLink_Button'], $scope->getItem(), [], $scope, true);
