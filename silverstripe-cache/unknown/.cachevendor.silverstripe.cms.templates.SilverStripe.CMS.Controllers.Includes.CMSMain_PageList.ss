...
$val .= \SilverStripe\View\SSViewer::execute_template([["type" => "Includes", 'SilverStripe\\CMS\\Controllers\\CMSMain_ListView'], 'SilverStripe\\CMS\\Controllers\\CMSMain_ListView'], $scope->getItem(), [], $scope, true);
