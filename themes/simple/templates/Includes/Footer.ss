		...
		<div class="container text-start">
			<div class="row">
				...
				<div class="col text-center">
					<img src="$resourceURL('themes/simple/images/59img_6919-removebg-preview.png')" alt="" class="img-fluid bg-light" width="100"
						height="100">
					<img src="$resourceURL('themes/simple/images/Logo_Mastercard_HiRes-removebg-preview.png')" alt="" class="img-fluid bg-light"
						width="75" height="20">
					<img src="$resourceURL('themes/simple/images/images-removebg-preview.png')" alt="" class="img-fluid bg-light" width="150"
						height="100">
				</div>
