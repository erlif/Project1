...
<div class="container mt-5 ">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="http://localhost/pindah/shop-page">Shop</a></li>
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
        <% with $Loki %>
            <div class="rows d-flex">
                <div class="col-4">
                    <img src="$Sofa.URL" alt="" class="img-fluid " id="image">
                    <div class="owl-carousel owl-theme mt-2">
                        <div class="item">
                            <h4><img src="$Sofa.URL" alt="" class="img-fluid"></h4>
                        </div>
                        <div class="item">
                            <h4><img src="$Sofa2.URL" alt="" class="img-fluid"></h4>
                        </div>
                        <div class="item">
                            <h4><img src="$Sofa3.URL" alt="" class="img-fluid"></h4>
                        </div>
                    </div>
