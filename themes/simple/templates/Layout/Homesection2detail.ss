                ...
                <div class="shadow-lg p-3 mb-5 bg-body rounded">
                    <% with $Koma %>
                        <div class="rows d-flex">
                            <div class="col-4">
                                <img src="$section2.URL" alt="" class="img-fluid " id="image">
                                <div class="owl-carousel owl-theme mt-2">
                                    <div class="item">
                                        <h4><img src="$section2.URL" alt="" class="img-fluid"></h4>
                                    </div>
                                    <div class="item">
                                        <h4><img src="$section2.URL" alt="" class="img-fluid"></h4>
                                    </div>
                                ...
                                <ul class="nav nav-pills mb-3 gap-2" id="pills-tab" role="tablist">
                                    <li class="item" role="presentation" style="list-style-type: none;">
                                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                            ...
                                            style="background-color:#b18b5e; color:black;">Detail</button>
                                    </li>
                                    <li class="item" role="presentation" style="list-style-type: none;">
