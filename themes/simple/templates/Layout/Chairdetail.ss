...
<div class="container mt-5 ">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Chair</li>
        </ol>
    </nav>
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
        <% with $Kelo %>
            <div class="rows d-flex">
                <div class="col-4">
                    <img src="$Chair.URL" alt="" class="img-fluid " id="image">
                    <div class="owl-carousel owl-theme mt-2">
                        <div class="item">
                            <h4><img src="$Chair.URL" alt="" class="img-fluid"></h4>
                        </div>
                        <div class="item">
                            <h4><img src="$Chair2.URL" alt="" class="img-fluid"></h4>
                        </div>
                        <div class="item">
                            <h4><img src="$Chair3.URL" alt="" class="img-fluid"></h4>
                        </div>
                    </div>
